...
#get input options
try:
    options, remainder = getopt.getopt(sys.argv[1:], 'p:m:s:h', ['SERVER_PORT=',
                                                             'MODE=',
                                                             'PACKET_SIZE=',
                                                             'help'                                                             ])
...
if MODE=='uplink':
 ...
 #change below (3->2) for single path android for now
